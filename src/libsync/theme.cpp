...
#else
    return QString::fromLatin1("https://docs.cloudsecurium.com/desktop/%1.%2/").arg(MIRALL_VERSION_MAJOR).arg(MIRALL_VERSION_MINOR);
#endif
}
...
QString Theme::gitSHA1() const
{
    ...
    const QString githubPrefix(QLatin1String(
        "https://github.com/cloudsecurium/desktop/commit/"));
